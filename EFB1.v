...
/* Module Version: 1.0 */
/* E:\lscc\diamond\1.4\ispfpga\bin\nt\scuba.exe -w -n EFB1 -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 2.08 -i2c1 -i2c1_freq 100 -i2c1_sa 0001001 -i2c1_addr 7 -spi -spi_mode Both -spi_rxo -spi_rxr -spi_txo -spi_txr -spi_en -spi_freq .5 -spi_cs 2 -dev 256 -e  */
/* Wed Jun 20 14:40:37 2012 */


`timescale 1 ns / 1 ps
module EFB1 (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, wb_adr_i, 
    wb_dat_i, wb_dat_o, wb_ack_o, i2c1_scl, i2c1_sda, i2c1_irqo, spi_clk, 
    spi_miso, spi_mosi, spi_scsn, spi_csn, spi_irq);
    input wire wb_clk_i;
    input wire wb_rst_i;
    input wire wb_cyc_i;
    input wire wb_stb_i;
    ...
    defparam EFBInst_0.SPI_CLK_DIVIDER = 4 ;
    ...
    EFB EFBInst_0 (.WBCLKI(wb_clk_i), .WBRSTI(wb_rst_i), .WBCYCI(wb_cyc_i), 
        ...
        .SPIMCSN5(), .SPIMCSN4(), .SPIMCSN3(), .SPIMCSN2(), .SPIMCSN1(spi_csn[1]), 
        .SPIMCSN0(spi_csn[0]), .SPICSNEN(), .SPIIRQO(spi_irq), .TCINT(), 
        .TCOC(), .WBCUFMIRQ(), .CFGWAKE(), .CFGSTDBY());
